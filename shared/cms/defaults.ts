...
export const DEFAULT_GLOBAL_SETTINGS: GlobalSettingsContent = {
  ...
  priorityModalBody: "This is where new features, CMS sections, and page updates are tested before going live to production. Take a look around or manage content inside the studio.",
  priorityModalPillText: "PREVIEW",
  priorityModalButtonLabel: "Manage in Sanity Studio",
  priorityModalButtonLink: "/api/studio",
