...
export const DEFAULT_GLOBAL_SETTINGS: GlobalSettingsContent = {
  ...
  priorityModalBody: "This preview environment displays unpublished changes. You can review drafts on the drafts dashboard, or edit content in Sanity Studio. This window showcases our priority dialog style, while the corner popup demonstrates our standard announcement style. Below is a test form to preview how form submissions work within this dialog.",
  ...
  priorityModalFormButtonLabel: "Send Test Submission",
