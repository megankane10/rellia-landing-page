    ...
    .child(
      S.list()
        ...
        .items([
          ...
          singleton(S, 'Explore Alumni directory', 'networkAlumniDirectoryPage', DocumentTextIcon),
          singleton(S, 'Advisors page', 'networkAdvisorsPage', DocumentTextIcon),
          singleton(S, 'Explore Advisors directory', 'networkAdvisorsDirectoryPage', DocumentTextIcon),
