...
export const paymentPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Path or URL for the full-screen welcome photo (e.g. /images/membership-splash.jpg).',
    ...
    defineField({
      ...
      description: 'Separate from the splash image. Path or URL (e.g. /images/benefits-payment.jpg).',
      initialValue: '/images/benefits-payment.jpg',
      group: 'content',
      fieldset: 'benefitsDivider',
