...
const legacyMembershipFields = [
  ...
  defineField({
    name: 'questionsTitle',
    type: 'string',
    title: 'Questions strip headline (legacy)',
    hidden: true,
    readOnly: true,
    group: 'content',
  }),
  defineField({
    ...
    type: 'string',
    title: 'Questions FAQ label (legacy)',
    hidden: true,
    readOnly: true,
    group: 'content',
  }),
  defineField({
    ...
    type: 'string',
    title: 'Questions FAQ path (legacy)',
    hidden: true,
    readOnly: true,
    group: 'content',
  }),
  defineField({
    ...
    type: 'string',
    title: 'Questions contact label (legacy)',
    hidden: true,
    readOnly: true,
    group: 'content',
  }),
  defineField({
    ...
    type: 'string',
    title: 'Questions contact path (legacy)',
    hidden: true,
    readOnly: true,
    group: 'content',
  }),
