...
/** Taller thumbnail — inset via card padding. */
export const RELATED_COMPACT_IMAGE_CLASS =
  "relative aspect-[5/4] w-full shrink-0 overflow-hidden rounded-xl"

/** Square event card image — full artwork visible inside the frame. */
export const RELATED_COMPACT_EVENT_IMAGE_CLASS =
...
export const RELATED_COMPACT_CARD_INSET_CLASS = "p-2 sm:p-3"
...
export const RELATED_COMPACT_TITLE_CLASS =
  "line-clamp-2 font-host-grotesk text-lg font-semibold leading-snug text-black group-hover:text-rellia-teal group-hover:underline group-hover:underline-offset-4 md:text-xl"
