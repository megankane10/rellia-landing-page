...
export const StoryPostHero = ({
  ...
  return (
    <section className="relative overflow-hidden bg-rellia-cream pt-24 pb-12 md:pt-32 md:pb-16">
          ...
          <ScrollReveal>
            ...
            >
              <div className="flex min-w-0 flex-col">
                <div className="inline-flex w-fit items-center gap-2 rounded-full bg-rellia-mint px-3 py-1.5">
