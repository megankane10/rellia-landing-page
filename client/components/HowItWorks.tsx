      ...
      <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <div className="w-full lg:w-[380px] xl:w-[440px] shrink-0">
          <img
            ...
            className="w-full h-[380px] sm:h-[480px] lg:h-[700px] object-cover rounded-[13px]"
          />
        </div>
            ...
            {steps.map((step) => {
              ...
              return (
                <div key={step.title} className="flex items-start gap-5">
                  {/* Icon box */}
                  <div className="w-14 h-14 bg-rellia-mint/20 rounded-md flex items-center justify-center shrink-0 mt-0.5">
                    <Icon className="w-7 h-7 text-rellia-teal" strokeWidth={1.75} />
                  </div>

                  {/* Text */}
                  <div className="flex flex-col gap-1.5">
                    <h3 className="font-host-grotesk font-semibold text-black text-xl md:text-2xl leading-tight tracking-tight">
                      {step.title}
                    </h3>
