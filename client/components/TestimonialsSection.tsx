        ...
        <ScrollReveal className="mb-10 md:mb-14">
          <div className="relative isolate mx-auto flex w-full max-w-3xl flex-col items-center text-center">
            ...
            <div className="relative z-[1] flex flex-col items-center">
              ...
              <h2 className="font-host-grotesk font-semibold text-rellia-teal [&_span]:text-rellia-teal [&_span]:!text-rellia-teal text-3xl md:text-[40px] leading-tight tracking-tight max-w-3xl text-balance">
