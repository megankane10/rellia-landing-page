...
export function AboutCtaBanner({
  ...
  body = "If you're a founder who wants to do this right, we have the network and expertise to make it happen.",
  founderLabel = "Apply to join as a founder",
  teamLabel = "Contact us to join the Rellia team",
}: AboutCtaBannerProps) {
  return (
