    ...
    <div className="min-h-screen overflow-x-hidden bg-white font-host-grotesk">
      <section className="relative min-h-screen w-full">
        <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[45%_55%] xl:grid-cols-[40%_60%]">
          <AdminAuthLeftPanel />
          <div className="relative flex min-h-[480px] flex-col items-center justify-center bg-white px-6 py-14 md:px-12 md:py-20 lg:px-16 lg:min-h-screen">
    ...
    <div className="absolute inset-0">
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        <div className="pt-28 md:pt-36 lg:pt-44">
          ...
          >
            <img src={LOGO_SRC} alt="Rellia Health" className="h-16 w-auto md:h-20 lg:h-24" />
          </Link>
        </div>

        <div className="flex flex-1 flex-col justify-center py-10 lg:py-14">
        <p className="max-w-md text-left font-urbanist text-2xl font-medium leading-snug text-white md:text-3xl lg:text-[2rem] lg:leading-tight">
          The central operating hub for Rellia Health.
        </p>
      </div>
    </div>
