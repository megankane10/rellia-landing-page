...
import {
  AIRTABLE_SITE_STATUS_LABELS,
  airtableProfileNeedsAttention,
...
const siteStatusLabel = (status: AirtableDirectoryQueueRow["siteStatus"]) =>
  AIRTABLE_SITE_STATUS_LABELS[status]
...
const ProfileNameLink = ({ row }: { row: AirtableDirectoryQueueRow }) => (
  <AdminAttentionNameLink
    ...
    needsAttention={airtableProfileNeedsAttention(row.siteStatus)}
    linkClassName="truncate font-medium"
  >
    {row.displayName}
  </AdminAttentionNameLink>
)
