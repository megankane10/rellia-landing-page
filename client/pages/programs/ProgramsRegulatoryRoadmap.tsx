...
export default function ProgramsRegulatoryRoadmap() {
  return <ProgramPageLayout cms={CMS} heroImageSrc="/images/program-regulatoryRoadmap.png" heroImageAlt="Regulatory Roadmap" outcomesSectionId="regulatory-outcomes" staticBlocks={REGULATORY_ROADMAP_STATIC_BLOCKS} isWaitlist />
}
