...
export default function ProgramsAdvanceDataroom() {
  return <ProgramPageLayout cms={CMS} cmsSlug="advance-data-room-deep-dive" heroImageSrc="/images/programs-DataRoom.png" heroImageAlt="Advance: Data Room Deep Dive" outcomesSectionId="advance-outcomes" staticBlocks={ADVANCE_DATAROOM_STATIC_BLOCKS} isWaitlist />
}
