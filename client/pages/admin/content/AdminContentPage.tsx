          ...
          {sourceTab === "sanity" ? (
            ...
            >
              <div className="space-y-3 font-urbanist text-sm text-muted-foreground">
                ...
                <p>
                  <strong>Site status</strong> compares each row to Sanity: <em>Not on site</em>, <em>Draft in CMS</em>,
                  or <em>Live</em>. Click a profile name to review, preview sections, and sync to CMS.
                </p>
                <p>
