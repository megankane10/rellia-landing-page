...
.ds-submit-grid { align-items:stretch; }
.ds-action-card { background:white; border-radius:14px; border:1px solid rgba(12,61,73,0.08); padding:1.5rem; display:flex; flex-direction:column; gap:12px; align-self:stretch; }
.ds-action-card .ds-submit-btn { margin-top:auto; }
...
/* Mobile: put progress/sidebar above content (no overlap) */
@media (max-width: 900px) {
  .ds-shell { display:flex; flex-direction:column; }
  .ds-sidebar { position:relative; top:auto; height:auto; }
  .ds-sidebar-nav { display:none; }
  .ds-gate, .ds-survey-inner, .ds-submit, .ds-report { padding:1.25rem; }
}
`;
