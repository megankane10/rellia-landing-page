...
export const statusBadgeClass = (status: SubmissionStatus) => {
  ...
  if (status === "In Progress") {
    return `${base} bg-orange-50 text-orange-700 border-orange-200/70 hover:bg-orange-50 dark:bg-orange-500/10 dark:text-orange-400 dark:border-orange-500/70 dark:hover:bg-orange-500/10`
  }
